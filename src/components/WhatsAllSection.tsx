...
const WhatsAllSection = () => {
  ...
  return (
    ...
    >
      <div className="relative bg-[#0a0f0d] border border-[#25D366]/15 rounded-[2.5rem] overflow-hidden">
        ...
        <div className="relative p-8 lg:p-12">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#25D366] to-[#128C7E] flex items-center justify-center">
            ...
            <div>
              ...
              <h2 className="text-2xl lg:text-3xl font-extrabold text-hub-text">WhatsAll Bot — Outreach automat pe WhatsApp</h2>
            </div>
          </div>
          ...
          <div className="aspect-video rounded-2xl overflow-hidden bg-black/50 border border-white/5 mb-8">
            <video className="w-full h-full object-cover" controls muted loop playsInline poster="">
              ...
              <div className="flex items-center justify-center h-full text-hub-muted">Video placeholder</div>
            </video>
          </div>

          <p className="text-hub-text font-bold mb-2">Automatizare completă pentru outreach B2B pe WhatsApp</p>
          <p className="text-hub-muted text-sm mb-8">Trimite mii de mesaje personalizate cu comportament uman simulat — fără intervenție manuală.</p>
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            {[
              ...
              <div key={i} className="text-center p-4 rounded-xl bg-[#25D366]/5 border border-[#25D366]/10">
                <div className="text-2xl font-extrabold text-[#25D366]">{s.value}</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
            {features.map((f, i) => (
              <div key={i} className="flex items-start gap-3 p-4 rounded-xl border border-white/5 hover:border-[#25D366]/20 transition-colors">
          ...
          <button
            ...
            className="w-full flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10 mb-6 text-hub-text font-medium"
          >
            Quick Start Guide
            <ChevronDown className={`w-5 h-5 transition-transform ${guideOpen ? 'rotate-180' : ''}`} />
          </button>
          {guideOpen && (
            <div className="p-6 rounded-xl bg-white/5 border border-white/10 mb-6 text-sm text-hub-muted space-y-3">
          ...
          <a
            ...
            className="block w-full text-center py-4 rounded-2xl bg-gradient-to-r from-[#25D366] to-[#128C7E] text-white font-bold hover:opacity-90 transition-opacity"
          >
