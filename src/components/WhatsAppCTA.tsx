...
const WhatsAppCTA = () => {
  ...
  return (
    ...
    >
      <div className="relative bg-hub-card border border-emerald-500/20 rounded-2xl lg:rounded-3xl p-8 overflow-hidden">
        ...
        <div className="relative">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-lg font-bold text-hub-text">{t.whatsappHeadline}</h3>
            </div>
            <span className="flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full bg-white/5 text-hub-muted border border-white/10">
          ...
          <a
            ...
            className="block w-full text-center py-3 rounded-xl bg-[#25D366] hover:bg-[#20ba5a] text-white font-semibold transition-colors"
          >
            {t.whatsappButton}
          </a>
        </div>
